...
<body>
    ...
    <a class="btn btn-primary alinha" href="../../index.php?classe=Compra&metodo=create" role="button">Novo</a>
    <div class="conteiner-agendamento"> 
        <table class="table table-bordered">
            ...
            foreach ($compras as $compra) {
                ...
                echo '<a class="btn btn-primary" href="../../index.php?classe=Compra&metodo=show&id=' . $compra->getId() . '">Mostrar</a>';
                echo '</div>';
                echo '</td>';
                echo '</tr>';
